...
// async function searchRecipesByTitle(title) {
//   try {
//     const apiUrl = `https://tasty-treats-backend.p.goit.global/api/recipes?title=${title}`;
...
//   try {
//     const searchValue = refs.filterInputEl.value.toLowerCase().trim();
//     const recipes = await searchRecipesByTitle(searchValue);
//     refs.galleryListEl.innerHTML = '';
//     recipes.forEach(recipe => {
//       const card = createRecipeCard(recipe);
//       refs.galleryListEl.appendChild(card);
//     });
//   } catch (error) {}
// }
const handleInput = e => {
